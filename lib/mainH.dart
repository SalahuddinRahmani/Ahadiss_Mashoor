...
class _HadisState extends State<Hadis> {
  ...
  List name = [
    ' دو کلمه که نزد خداوند زیاد محبوب است',
    'نخست حق مادر یا پدر',
    'تامین نیاز زنان بیوه',
    'رفت و امد به مسجد',
    'کافر گفتن برادرش خویش',
    'خواندن نمازهای پنجگانه و جمعه',
    'توبه کردن قبل از طلوع افتاب',
    'ثواب جاریه',
    'دعوت به کار خیر',
    'حرام بودن حق مسلمان بر مسلمان دیگر',
    'حفظ ابروی برادر مسلمان'
  ];
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: Scaffold(
          backgroundColor: Color.fromRGBO(10, 80, 88, 1.0),
          appBar: AppBar(
